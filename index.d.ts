...
export declare class PointG2 extends ProjectivePoint<Fp2> {
    ...
    static hashToCurve(msg: Bytes): PointG2;
...
export declare function sign(message: Uint8Array, privateKey: PrivateKey): Uint8Array;
export declare function sign(message: string, privateKey: PrivateKey): string;
export declare function sign(message: PointG2, privateKey: PrivateKey): PointG2;
export declare function verify(signature: G2Hex, message: G2Hex, publicKey: G1Hex): boolean;
...
export declare function verifyBatch(signature: G2Hex, messages: G2Hex[], publicKeys: G1Hex[]): boolean;
